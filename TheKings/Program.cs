...
namespace TheKings
{
    public class Program
    {
        ...
        public static Action<string> logFunc = i => Console.WriteLine(i);
        ...
        public static void Main()
        {
            ...
            var kings = statsService.GetKingWhoRuledLongest();
            ShowQuestionAndAnswer(
            ...
            var houses = statsService.GetHouseWhichRuledLongest();
            ShowQuestionAndAnswer(
            ...
            var names = statsService.GetMostCommonFirstName();
            ShowQuestionAndAnswer(
